...
function upload_zips(d,callback){
	...
	callback(uploadFile,geo,concept,supply,audience,technology,contextual,d.concept_id,d.geo_region,d.supply_source_id,temp,d.tech_id,d.contextual_id,d.name);
}
...
function add_aud(s,c,callback){
	...
	error: function(xml,jqXHR, textStatus, errorThrown) {
		//var err = xhr.responseXML.getElementsByTagName("field-error");
		var err = xml.responseXML.getElementsByTagName("error")[0];
		console.log(err);
