...
function upload_zips(d,callback){
	...
	callback(uploadFile,geo,concept,supply,audience,technology,d.concept_id,d.geo_region,d.supply_source_id,d.aud_id,d.tech_id,d.name);
}
...
/*  	var fileUpload = document.getElementById("fileSelect");
    if (fileUpload.value != null) {
		...
		var f = files[0];  */
			...
			//var count = i +1;			
			upload_zips(data,function(upload,geo,concept,supply,aud,tech,c_id,g_id,s_id,a_id,t_id,name){
