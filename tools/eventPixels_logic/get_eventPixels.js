...
function get_eventPixels(ad){
	...
	aggregate_pages("https://adroit-tools.mediamath.com/t1/api/v2.0/pixel_bundles/limit/advertiser.agency.organization="+ad+"?sort_by=name&q=eligible%3D%3D1")
		.then(function(xml) { push_entities_to_multiselect(xml, "#eventPixels_list")});
} */