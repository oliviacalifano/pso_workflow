...
function update_campaign_list(adv_ids)
{
	...
	if(!adv_ids){
		...
		for(var i=0; i<adv_ids.length; i++){
			...
			url = "https://adroit-tools.mediamath.com/t1/api/v2.0/campaigns/limit/advertiser="+adv_ids[i]+"?q=status%3D%3D1%26end_date%3E%3D" + date + "%26start_date%3C%3D" + date + "%26spend_cap_enabled%3D%3D1";
