		...
		for(var i=0; i<strat_list.length; i++) {
			...
			if(mod_dev !== null){
				get_dev_targets(current_strat, function(current_strat, final_list) 
				{
					...
					if(add_remove == 'add'){
						final_list[include_exclude] = add_to_final_list(final_list[include_exclude], mod_dev);
					}
			...
			if(mod_inv !== null){
				get_inv_targets(current_strat, function(current_strat, final_list) 
				{
					...
					if(add_remove == 'add'){
						final_list[include_exclude] = add_to_final_list(final_list[include_exclude], mod_inv);
					}
					if(add_remove == 'remove'){
			...
			if(mod_cspd !== null){
				get_cspd_targets(current_strat, function(current_strat, final_list) 
				{
					...
					if(add_remove == 'add'){
						final_list[include_exclude] = add_to_final_list(final_list[include_exclude], mod_cspd);
					}
					if(add_remove == 'remove'){
			...
			if(mod_brwsr !== null){
				get_brwsr_targets(current_strat, function(current_strat, final_list) 
				{
					...
					if(add_remove == 'add'){
						final_list[include_exclude] = add_to_final_list(final_list[include_exclude], mod_brwsr);
					}
					if(add_remove == 'remove'){
			...
			if(mod_ispx !== null){
				get_ispx_targets(current_strat, function(current_strat, final_list) 
				{
					...
					if(add_remove == 'add'){
						final_list[include_exclude] = add_to_final_list(final_list[include_exclude], mod_ispx);
					}
					if(add_remove == 'remove'){
